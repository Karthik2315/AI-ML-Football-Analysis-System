...
class Tracker:
    ...
    def get_object_tracks(self, frames,read_from_stub=False,stub_path=None):
        ...
        for frame_num,detection in enumerate(detections):
          ...
          for object_idx,object in enumerate(detection_supervision.class_id):
            if cls_names[object] == "goalkeeper":
          ...
          for frame_detection in detection_supervision:
              ...
              if cls_id == cls_names_inv["ball"]:
                  track["ball"][frame_num][1] = {"bbox":bbox}
    ...
    def draw_ellipse(self,frame,bbox,color,track_id=None):
        ...
        if track_id is not None:    
            cv2.rectangle(frame, (int(x1_rect), int(y1_rect)), (int(x2_rect), int(y2_rect)), color, thickness=cv2.FILLED)
